		...
		<div className={styles.wrapper}>
			<div className={styles.home_container}>
				<div className={styles.info}>
					...
					<p>
						If you&apos;re ever around Melbourne, let&apos;s hang out. Looking for new
						opportunities. Reach out at{' '}
						<a href='https://twitter.com/mjbramich' target='_blank' rel='noreferrer'>
							@mjbramich
						</a>{' '}
						or{' '}
						<a href='mailto:mjbramich6@gmail.com' target='_blank' rel='noreferrer'>
							mjbramich6@gmail.com
						</a>
						.
					</p>
					<Socials />
					...
					<Card
						title='Photos'
						desc='View some of my photos. View some of my photos. View some of my photos.'
			...
			{typeof size.width !== 'undefined' && size.width >= 800 && <Photos />}
		</div>
	);
};
